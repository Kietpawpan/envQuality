...
// https://ccf.tgo.or.th/eplatform-home/ Potential reduction in 2573 B.E. are deemed as the reduction targets.
		...
		//Pollutors
		const pollutorKH = 1801;
		const pollutorRE = 853;		
		const pollutorKS = 700;		
		const pollutorMK = 761;
		const pollutorNB = 226;
		const pollutorTarget =[pollutorKH,pollutorRE,pollutorKS,pollutorMK,pollutorNB];
		//Polluters Inspected
		const pollutorKHc = 244;
		const pollutorREc = 81;		
		const pollutorKSc = 69;		
		const pollutorMKc = 80;
		const pollutorNBc = 24;
		const pollutorData =[pollutorKHc,pollutorREc,pollutorKSc,pollutorMKc,pollutorNBc];
