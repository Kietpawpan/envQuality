// Data for the charts (replace with dynamic data from an API)
		...
		const targets = [61, 37, "ร้อยละ 80", "ร้อยละ 50", 70, "ร้อยละ 21 จากปีฐาน"]; // Target note in the tables.
		const targetsText = ["61 Dmnl", "37 ppm", "ร้อยละ 80", "ร้อยละ 50", "70 dBA", "ร้อยละ 21 จากปีฐาน"]; // Target note in the tables.
		const Wtargets = 0.8; // 80% solid waste are expected to be properly managed.
	    const pm25target = 37; // ppm
